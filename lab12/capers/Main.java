...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        switch (args[0]) {
            ...
            case "story":
                writeStory(args);
                Utils.readContentsAsString(_story);
                break;
            case "dog":
                makeDog(args);
                break;
    ...
    public static void setupPersistence() {
        CAPERS_FOLDER.mkdir();
        _dogFolder = new File(CAPERS_FOLDER, "dogs");
        _dogFolder.mkdir();
    ...
    public static void writeStory(String[] args) {
        ...
        String current = Utils.readContentsAsString(_story);
        current += (args[1] + "\n");
    ...
    public static void makeDog(String[] args) {
        ...
        Dog current = new Dog(args[1],args[2], Integer.parseInt(args[3]));
        current.saveDog();
